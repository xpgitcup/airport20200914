...
<html>
    ...
    <body>
        ...
        <div id="show-unitSystem" class="content scaffold-show" role="main">
            ...
            <f:display bean="unitSystem" />
            <g:form resource="${this.unitSystem}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.unitSystem}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
