...
<html>
    ...
    <body>
        ...
        <div id="show-quantityUnit" class="content scaffold-show" role="main">
            ...
            <f:display bean="quantityUnit" />
            <g:form resource="${this.quantityUnit}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.quantityUnit}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
